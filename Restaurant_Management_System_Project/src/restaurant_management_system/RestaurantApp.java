...
public class RestaurantApp {
    ...
    // ========== Main Menu ==========
    private static void mainMenu()throws InvalidCustomerException, NumberLimtExceedException {
        while (true) {
    ...
    private static void registerCustomer() throws InvalidCustomerException,NumberLimtExceedException{
        System.out.print("Enter name: ");
        String name = sc.nextLine();
        System.out.print("Enter phone: ");
        String phone = sc.nextLine();
        
        if(phone.length()>10 || phone.length()<10) {throw new NumberLimtExceedException("Please Enter Correct Mobile Number..");
        }
        Customer c = new Customer(name, phone);
        if(c.name.endsWith(phone))
        customers.add(c);
    ...
    private static void customerLogin() throws InvalidCustomerException{
